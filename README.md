...
- **PPP**
  The following parameters correspond to the PPP configuration. There are two modes, "Queue" and "Classic". The parameters in the two modes are different. - In the "Queue" mode, a typical set of parameters looks like:
